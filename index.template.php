...
<div id="wrapper" style="width: ' . $settings['forum_width'] . '">' : '', '';
	...
	{
		echo '
				<img class="avatar" src="', (empty($context['user']['avatar']) ? $settings['images_url'] . '/custom/avatardefault.png' : $context['user']['avatar']['href']), '" alt="" />
				<ul class="reset">
	...
	echo '
		...
		echo '
				...
				<div class="search"><form id="search_form" action="', $scripturl, '?action=search2" method="post" accept-charset="', $context['character_set'], '">
					...
					<input class="search_input" type="text" name="search" value="', $txt['search'], '..." onfocus="this.value = \'\';" onblur="if(this.value==\'\') this.value=\'', $txt['search'], '...\';" />
